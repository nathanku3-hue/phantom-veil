...
1. `Front Card`: current delta, one question, recommended next decision, scope limit, and stop rule.
...
6. `Boundaries`: forbidden actions, approval gates, and stop rules.
